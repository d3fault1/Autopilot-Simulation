...
MODEL                = LQR_Control
MODULES              = rt_logging_simtarget.c LQR_Control.c LQR_Control_capi.c LQR_Control_data.c LQR_Control_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = LQR_Control.exe
MAKEFILE             = LQR_Control.mk
MATLAB_ROOT          = G:/Additional Installed/Matlab Installed
ALT_MATLAB_ROOT      = G:/Additional Installed/Matlab Installed
START_DIR            = I:/matlab/Autopilot Project
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/LQR_Control \
